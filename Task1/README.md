...
Implement a system for dynamically expanding the chatbot's knowledge base by periodically incorporating new information from external sources. The chatbot should automatically update its vector database and improve its responses as new information becomes available.
...
Both datasets use the following columns:
